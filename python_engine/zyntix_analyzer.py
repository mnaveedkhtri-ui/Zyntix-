...
def main():
    ...
    target_keyword = input("\nEnter Target Keyword (e.g., Best Plumbers in London): ")
    ...
    competitor_url = input("Enter a competitor URL to analyze (e.g., https://en.wikipedia.org/wiki/Search_engine_optimization): ")
