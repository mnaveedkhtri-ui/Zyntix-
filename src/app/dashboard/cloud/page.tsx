                ...
                {isFinished && (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-emerald-500/80 font-medium">Successfully created {profileCount} Cloud Authority Links with backlinks.</p>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-cyan-500/5 border border-cyan-500/20 p-6 rounded-2xl shadow-xl">
              ...
              <p className="text-sm text-cyan-400/80 leading-relaxed font-medium">
                Cloud Authority Links provide massive foundational trust to new domains. It's highly recommended to use the 30-Day Drip feature for these.
              </p>
            </div>
          </div>
        </div>
