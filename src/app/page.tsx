      ...
      <motion.main style={{ y, opacity }} className="relative pt-40 pb-32 px-6 flex flex-col items-center justify-center text-center min-h-[90vh]">
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-cyan-300 text-xs font-bold uppercase tracking-widest mb-8 backdrop-blur-md shadow-xl">
            ...
            The Next Evolution of Digital PR
          </motion.div>
          ...
          <motion.p variants={itemVariants} className="text-lg md:text-2xl text-slate-400 mb-12 max-w-3xl font-medium leading-relaxed">
            The world's first <strong className="text-white">Entity-Based NLP Engine</strong> that automatically rewrites and publishes your content to high-DR networks in one click. Zero spam. Pure authority.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="mt-28 w-full border-t border-white/10 pt-10 relative">
            <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.2em] mb-8">Natively integrated with top-tier authorities</p>
      ...
      <section className="py-32 bg-[#020617] relative z-20" id="features">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white mb-6">Engineered for Perfection</h2>
            <p className="text-lg text-slate-400 font-medium max-w-2xl mx-auto">Not just another automation tool. A complete digital PR infrastructure designed to manipulate authority graphs ethically.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="relative h-full bg-[#050B14] p-10 rounded-[22px] border border-white/5 overflow-hidden">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">Semantic NLP Engine</h3>
                <p className="text-slate-400 text-lg leading-relaxed max-w-xl">
                  We don't do keyword stuffing. The AI analyzes your core URL, extracts top-level entities, and generates highly authoritative, Information-Gain focused content.
                </p>
            ...
            >
              <div className="relative h-full bg-[#050B14] p-8 rounded-[22px] border border-white/5">
                ...
                <h3 className="text-xl font-bold text-white mb-3">100% White-Hat</h3>
                <p className="text-slate-400 leading-relaxed">
                  Legitimate content syndication using official APIs and Canonical tags. Zero duplicate content penalties.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative h-full bg-[#050B14] p-8 rounded-[22px] border border-white/5">
                ...
                <h3 className="text-xl font-bold text-white mb-3">1-Click Blast</h3>
                <p className="text-slate-400 leading-relaxed">
                  No complex flows. Drop your URL, hit Blast, and let the background queues handle the distribution instantly.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative h-full bg-[#050B14] p-10 rounded-[22px] border border-white/5 flex flex-col md:flex-row gap-8 items-center justify-between overflow-hidden">
                <div className="relative z-10 max-w-lg">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3">Professional Media Assets</h3>
                  <p className="text-slate-400 leading-relaxed">
                    Say goodbye to deformed AI images. We integrate directly with Unsplash's Premium API to fetch breathtaking, real high-definition photography for your cover images.
                  </p>
                </div>
