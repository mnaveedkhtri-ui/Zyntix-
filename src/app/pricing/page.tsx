        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#050B14] border border-cyan-500/40 p-8 rounded-3xl shadow-[0_0_40px_rgba(6,182,212,0.15)] flex flex-col relative transform md:-translate-y-4">
            ...
            <div className="space-y-4 mb-10 flex-1">
              ...
              <div className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-cyan-400 shrink-0" /><span className="text-sm font-medium text-emerald-400">Instant Turbo Delivery Engine</span></div>
            </div>
