  ...
  return (
    <div className="relative min-h-screen bg-[#020617] text-slate-50 font-sans selection:bg-emerald-500/30 overflow-hidden">
      ...
      <main className="max-w-4xl mx-auto px-8 py-24 relative z-10">
        <h1 className="text-4xl md:text-5xl font-black mb-16 text-center">How <span className="text-emerald-400">Google Stacking</span> Works</h1>
        ...
        <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-800 before:to-transparent">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active hover:-translate-y-1 transition-transform">
            ...
            <div className="w-[calc(100%-5rem)] md:w-[calc(50%-3rem)] bg-[#050B14] p-8 rounded-3xl border border-slate-800 shadow-xl">
              ...
              <p className="text-slate-400 leading-relaxed">Generate a free JSON Service Account key from Google Cloud Console and paste it into Zyntix Settings.</p>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active hover:-translate-y-1 transition-transform">
            ...
            <div className="w-[calc(100%-5rem)] md:w-[calc(50%-3rem)] bg-[#050B14] p-8 rounded-3xl border border-slate-800 shadow-xl">
              <h3 className="font-bold text-xl mb-3 text-white">Configure Bulk Campaign</h3>
              <p className="text-slate-400 leading-relaxed">Enter your client's target URL, main keyword, and the desired quantity of documents (up to 500 at once).</p>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active hover:-translate-y-1 transition-transform">
            ...
            <div className="w-[calc(100%-5rem)] md:w-[calc(50%-3rem)] bg-[#050B14] p-8 rounded-3xl border border-slate-800 shadow-xl">
              <h3 className="font-bold text-xl mb-3 text-white">Deploy & Extract URLs</h3>
              <p className="text-slate-400 leading-relaxed">Zyntix engine automatically loops through the API, generating live public documents and saving the Live URLs directly to your dashboard.</p>
            </div>
          </div>
