  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-50 font-sans p-12 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl font-black tracking-tight mb-6 text-white">Integrations</h1>
        <p className="text-xl text-slate-400 font-medium mb-16">We natively support the most powerful Web 2.0 properties available today.</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-6 border border-white/5 bg-[#050B14] shadow-xl rounded-2xl flex items-center justify-between">
            <span className="text-xl font-bold text-white">Dev.to</span>
            <span className="text-xs font-bold px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full">Available</span>
          </div>
          <div className="p-6 border border-white/5 bg-[#050B14] shadow-xl rounded-2xl flex items-center justify-between">
            <span className="text-xl font-bold text-white">Blogger</span>
            <span className="text-xs font-bold px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full">Available</span>
          </div>
          <div className="p-6 border border-white/5 bg-[#050B14] shadow-xl rounded-2xl flex items-center justify-between">
            <span className="text-xl font-bold text-white">Hashnode</span>
            <span className="text-xs font-bold px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full">Available</span>
          </div>
          <div className="p-6 border border-white/5 bg-[#050B14] shadow-xl rounded-2xl flex items-center justify-between">
            <span className="text-xl font-bold text-white">Tumblr</span>
          ...
          <div className="p-6 border border-white/5 bg-[#050B14] shadow-xl rounded-2xl flex items-center justify-between">
            <span className="text-xl font-bold text-white">WordPress.com</span>
            <span className="text-xs font-bold px-3 py-1 bg-yellow-500/10 text-yellow-400 border border-yellow-500/20 rounded-full">Coming Soon</span>
          </div>
        </div>
      </div>
